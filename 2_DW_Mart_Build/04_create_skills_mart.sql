...
select '=== loading dim date month for skills mart ===' as info;
...
select '=== loading fact skill demand monthly for skills mart ===' as info;
...
select '=== skill demand fact dimension sample ===' as info;
